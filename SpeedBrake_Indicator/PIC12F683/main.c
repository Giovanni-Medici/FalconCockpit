 ...
 * File:   main.c
 * Author: Giovanni
 * This routine relies on PIC12F683
...
const int resetStepMicrosec = 800;
...
void main() {
    ...
    OSCCON = 0b1110001;     // Sets 8MHz processor and internal oscillator clock
